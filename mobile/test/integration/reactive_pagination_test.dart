...
void main() {
  ...
  group('Reactive Pagination Tests', () {
    ...
    test('loadMoreEvents calls subscription manager with correct parameters', () async {
      // Act: Call loadMoreEvents
      await videoEventService.loadMoreEvents(SubscriptionType.discovery, limit: 25);
      ...
      verify(mockSubscriptionManager.cancelSubscription('test-subscription-id')).called(1);
    });

    test('loadMoreEvents creates correct filter structure', () async {
      // Act: Call loadMoreEvents
      await videoEventService.loadMoreEvents(SubscriptionType.discovery, limit: 10);
    ...
    test('loadMoreEvents with empty list does not set until parameter', () async {
      // Arrange: Ensure discovery list is empty
      expect(videoEventService.discoveryVideos, isEmpty);
      
      // Act: Call loadMoreEvents
      await videoEventService.loadMoreEvents(SubscriptionType.discovery, limit: 15);
